...
public final class SourceTreeWithCodeCachingPreparationProcessorBuilderTest {
    ...
    public void createExpirationChecker_hasNotBeenSet_returnSourceAlwaysExpiredChecker() {
        ...
        final SourceTreeWithCodeCachingPreparationProcessorBuilder builder = Mockito
                .spy(new SourceTreeWithCodeCachingPreparationProcessorBuilder(cache));
    ...
    @Test
    public void createImportReplacer_hasNotBeenSet_returnLessImportReplacerImpl() {
        final FullCache cache = Mockito.mock(FullCache.class);
        final SourceTreeWithCodeCachingPreparationProcessorBuilder builder = Mockito
                .spy(new SourceTreeWithCodeCachingPreparationProcessorBuilder(cache));

        final LessImportReplacer importReplacer = builder.createImportReplacer();

        Assert.assertNotNull("Replacer instance", importReplacer);
        Assert.assertEquals("Replacer class", LessImportReplacerImpl.class, importReplacer.getClass());
    ...
    public void createImportReplacer_hasBeenSet_returnSetReplacer() {
        ...
        final LessImportReplacer importReplacer2 = builder.withImportReplacer(importReplacer).createImportReplacer();

        Assert.assertEquals("Replacer instance", importReplacer, importReplacer2);
    ...
    public void create_defaultValues() {
        ...
        final SourceTreeWithCodeCachingPreparationProcessor processor = builder.create();
        ...
        Assert.assertEquals("Code cache instance", cache, processor.codeCache);
        ...
        Assert.assertNotNull("Import checker instance", processor.importReplacer);
        Assert.assertEquals("Import checker class", LessImportReplacerImpl.class, processor.importReplacer.getClass());
